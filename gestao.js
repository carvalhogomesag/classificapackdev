...
// =========================================================================
// DICIONÁRIO DE DADOS ESTÁTICO HIERÁRQUICO COMPLETO (MAFRA)
// Estrutura de 3 Níveis: Concelho -> Freguesia -> Localidade -> Códigos Postais
// =========================================================================
...
/**
 * Processa o registo / edição de motorista com suporte a múltiplos setores atribuídos.
 */
export function handleDriverSubmit(e, drivers, selectedColor, renderCallback) {
    ...
    // Garante que nenhum dos setores já esteja em uso por outro motorista activo
...
/**
 * Renderiza os Setores existentes para atribuição no formulário do motorista
 */
...
/**
 * Cria ou atualiza um Setor de Entrega guardando as áreas selecionadas na árvore visual.
 * Uma seleção pode ser uma freguesia inteira ("AZUEIRA") ou específica ("AZUEIRA|Tourinha")
 */
...
/**
 * Renderiza visualmente os Setores e os seus respetivos territórios divididos (Freguesia ou Localidade)
 */
...
export function findDriverForZip(zip, sectors, drivers) {
    if (!zip) return null;
    const normalizedZip = zip.trim(); // Ex: "2665-018"
    ...
    // 1. Localiza a freguesia e a localidade exata do código de 7 dígitos no dicionário estático
    ...
    // 3. Procura o motorista associado a este Setor
...
/**
 * Renderiza o painel resumo de triagem por turno
 */
