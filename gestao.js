...
export function renderSectors(sectors, listaSetores, deleteSector) {
    ...
    listaSetores.innerHTML = sectors.length === 0 ? '<p class="text-sm text-gray-400 italic text-center py-4">Nenhum setor registado.</p>' : '';
