/**
 * sw.js
 * Versão v70 - Atualização da Arquitetura Componentizada e Injeção de CP
 * Faz: Controla o cache offline-first de todos os recursos estruturais e módulos da aplicação.
 */

const CACHE_NAME = 'classificapack-v70';
...
const ASSETS = [
  ...
  'js/geocoding.js',       // Módulo de geocodificação e autocomplete (v70)
